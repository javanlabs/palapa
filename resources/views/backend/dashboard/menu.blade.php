<div class="list-group list-group-menu">
    ...
    <a class="list-group-item {{ ($active == 'byStatus')?'active':'' }}" href="{{ route('dashboard.byStatus', compact('year')) }}"><span class="badge"><i class="fa-2x ion-ios-arrow-forward"></i></span> Perkara Baru - Perkara Ditutup</a>
    <a class="list-group-item {{ ($active == 'byJaksa')?'active':'' }}" href="{{ route('dashboard.byJaksa', compact('year')) }}"><span class="badge"><i class="fa-2x ion-ios-arrow-forward"></i></span> Perkara per Jaksa</a>
